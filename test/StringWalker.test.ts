...
describe('StringWalker', () => {
  ...
  test('constructor', () => {
    const walker = new StringWalker("in😀put")
  ...
  test('peek()', () => {
    ...
    expect(walker.peek()).toBe("inp😀ut\uD83Dx")
    expect(walker.peek(4)).toBe("inp😀")
    walker.seek(4)
  ...
  test('startsWith()', () => {
    ...
    expect(walker.startsWith("NP😀")).toBe(false)
    expect(walker.startsWith("NP😀", true)).toBe(true)
